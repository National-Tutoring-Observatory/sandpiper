  ...
  return (
    <div className="mb-2">
      <div className="mb-2 flex flex-wrap items-center justify-between gap-x-4 gap-y-1">
        <span className="text-muted-foreground text-heading">Started</span>
        <span className="text-body text-right">
          {getDateString(session.startedAt)}
        </span>
      </div>
      <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-1">
        <span className="text-muted-foreground text-heading">Finished</span>
        <span className="text-body text-right">
      ...
      {annotatedUtteranceCount > 0 && (
        <div className="mt-2 mb-4">
          <div className="text-muted-foreground text-heading mb-4">Summary</div>
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-card flex flex-col items-center rounded-lg border p-3">
              ...
              <div className="text-display">{annotatedUtteranceCount}</div>
            </div>
          </div>
        </div>
      )}
